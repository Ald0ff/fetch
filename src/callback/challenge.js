...
fetchData(`${API}/products`, function (error1, data1) {
    ...
    //se invoca nuevamente la función fetchData con el fin de acceder a 
    //un objeto puntual del arreglo data1, se envia como parámetros la url 
    //de la API apuntando al atributo del primer objeto de arreglo data1 y 
